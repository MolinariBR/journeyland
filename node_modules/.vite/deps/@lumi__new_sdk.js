  ...
  "node_modules/object-hash/dist/object_hash.js"(exports, module) {
    !function(e) {
      ...
      return function r2(o, i, u2) {
        ...
        for (var a2 = "function" == typeof __require && __require, e = 0; e < u2.length; e++) s2(u2[e]);
        return s2;
      }({ 1: [function(w2, b2, m2) {
        !(function(e, n, s2, c, d2, h, p, g2, y2) {
          "use strict";
          var r2 = w2("crypto");
          function t(e2, t2) {
            t2 = u2(e2, t2);
            var n2;
            return void 0 === (n2 = "passthrough" !== t2.algorithm ? r2.createHash(t2.algorithm) : new l()).write && (n2.write = n2.update, n2.end = n2.update), f2(t2, n2).dispatch(e2), n2.update || n2.end(""), n2.digest ? n2.digest("buffer" === t2.encoding ? void 0 : t2.encoding) : (e2 = n2.read(), "buffer" !== t2.encoding ? e2.toString(t2.encoding) : e2);
          }
          ...
          function u2(e2, t2) {
            ...
            for (var r3 = 0; r3 < o.length; ++r3) o[r3].toLowerCase() === n2.algorithm.toLowerCase() && (n2.algorithm = o[r3]);
          ...
          function f2(o2, t2, i2) {
            ...
            return { dispatch: function(e2) {
              ...
              if (i2.push(t3), void 0 !== s2 && s2.isBuffer && s2.isBuffer(t3)) return u3("buffer:"), u3(t3);
              ...
              })), u3("object:" + e2.length + ":"), n2 = this, e2.forEach(function(e3) {
                n2.dispatch(e3), u3(":"), o2.excludeValues || n2.dispatch(t3[e3]), u3(",");
              });
              if (!this["_" + r3]) {
              ...
              var r3 = [], t3 = e2.map(function(e3) {
                ...
                return f2(o2, t4, n3).dispatch(e3), r3 = r3.concat(n3.slice(i2.length)), t4.read().toString();
              });
          ...
          m2.writeToStream = function(e2, t2, n2) {
            return void 0 === n2 && (n2 = t2, t2 = {}), f2(t2 = u2(e2, t2), n2).dispatch(e2);
          };
        ...
        !(function(e2, t2, n, r2, o, i, u2, s2, a2) {
          !function(e3) {
            "use strict";
            var a3 = "undefined" != typeof Uint8Array ? Uint8Array : Array, t3 = "+".charCodeAt(0), n2 = "/".charCodeAt(0), r3 = "0".charCodeAt(0), o2 = "a".charCodeAt(0), i2 = "A".charCodeAt(0), u3 = "-".charCodeAt(0), s3 = "_".charCodeAt(0);
            function f3(e4) {
              e4 = e4.charCodeAt(0);
              return e4 === t3 || e4 === u3 ? 62 : e4 === n2 || e4 === s3 ? 63 : e4 < r3 ? -1 : e4 < r3 + 10 ? e4 - r3 + 26 + 26 : e4 < i2 + 26 ? e4 - i2 : e4 < o2 + 26 ? e4 - o2 + 26 : void 0;
            }
            e3.toByteArray = function(e4) {
              ...
              for (t4 = 0; t4 < i3; t4 += 4, 0) s4((16711680 & (n3 = f3(e4.charAt(t4)) << 18 | f3(e4.charAt(t4 + 1)) << 12 | f3(e4.charAt(t4 + 2)) << 6 | f3(e4.charAt(t4 + 3)))) >> 16), s4((65280 & n3) >> 8), s4(255 & n3);
              return 2 == r4 ? s4(255 & (n3 = f3(e4.charAt(t4)) << 2 | f3(e4.charAt(t4 + 1)) >> 4)) : 1 == r4 && (s4((n3 = f3(e4.charAt(t4)) << 10 | f3(e4.charAt(t4 + 1)) << 4 | f3(e4.charAt(t4 + 2)) >> 2) >> 8 & 255), s4(255 & n3)), o3;
            }, e3.fromByteArray = function(e4) {
              var t4, n3, r4, o3, i3 = e4.length % 3, u4 = "";
              function s4(e5) {
                return "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(e5);
              }
              for (t4 = 0, r4 = e4.length - i3; t4 < r4; t4 += 3) n3 = (e4[t4] << 16) + (e4[t4 + 1] << 8) + e4[t4 + 2], u4 += s4((o3 = n3) >> 18 & 63) + s4(o3 >> 12 & 63) + s4(o3 >> 6 & 63) + s4(63 & o3);
              switch (i3) {
                case 1:
                  u4 = (u4 += s4((n3 = e4[e4.length - 1]) >> 2)) + s4(n3 << 4 & 63) + "==";
                  break;
                case 2:
                  u4 = (u4 = (u4 += s4((n3 = (e4[e4.length - 2] << 8) + e4[e4.length - 1]) >> 10)) + s4(n3 >> 4 & 63)) + s4(n3 << 2 & 63) + "=";
              }
              return u4;
            };
        ...
        !(function(e2, n, f2, r2, h, p, g2, y2, w2) {
          var a2 = O2("base64-js"), i = O2("ieee754");
          function f2(e3, t2, n2) {
            if (!(this instanceof f2)) return new f2(e3, t2, n2);
            var r3, o2, i2, u3, s3 = typeof e3;
            if ("base64" === t2 && "string" == s3) for (e3 = (u3 = e3).trim ? u3.trim() : u3.replace(/^\s+|\s+$/g, ""); e3.length % 4 != 0; ) e3 += "=";
            if ("number" == s3) r3 = j(e3);
            else if ("string" == s3) r3 = f2.byteLength(e3, t2);
            else {
            ...
            else if ("string" == s3) o2.write(e3, 0, t2);
            else if ("number" == s3 && !f2._useTypedArrays && !n2) for (i2 = 0; i2 < r3; i2++) o2[i2] = 0;
            return o2;
          }
          ...
          function m2(e3, t2, n2, r3) {
            return f2._charsWritten = c(function(e4) {
              for (var t3, n3, r4 = [], o2 = 0; o2 < e4.length; o2++) n3 = e4.charCodeAt(o2), t3 = n3 >> 8, n3 = n3 % 256, r4.push(n3), r4.push(t3);
              return r4;
            }(t2), e3, n2, r3);
          }
          function v2(e3, t2, n2) {
            var r3 = "";
            n2 = Math.min(e3.length, n2);
            for (var o2 = t2; o2 < n2; o2++) r3 += String.fromCharCode(e3[o2]);
            return r3;
          }
          function o(e3, t2, n2, r3) {
            r3 || (d2("boolean" == typeof n2, "missing or invalid endian"), d2(null != t2, "missing offset"), d2(t2 + 1 < e3.length, "Trying to read beyond buffer length"));
            var o2, r3 = e3.length;
            if (!(r3 <= t2)) return n2 ? (o2 = e3[t2], t2 + 1 < r3 && (o2 |= e3[t2 + 1] << 8)) : (o2 = e3[t2] << 8, t2 + 1 < r3 && (o2 |= e3[t2 + 1])), o2;
          }
          function u2(e3, t2, n2, r3) {
            r3 || (d2("boolean" == typeof n2, "missing or invalid endian"), d2(null != t2, "missing offset"), d2(t2 + 3 < e3.length, "Trying to read beyond buffer length"));
            var o2, r3 = e3.length;
            if (!(r3 <= t2)) return n2 ? (t2 + 2 < r3 && (o2 = e3[t2 + 2] << 16), t2 + 1 < r3 && (o2 |= e3[t2 + 1] << 8), o2 |= e3[t2], t2 + 3 < r3 && (o2 += e3[t2 + 3] << 24 >>> 0)) : (t2 + 1 < r3 && (o2 = e3[t2 + 1] << 16), t2 + 2 < r3 && (o2 |= e3[t2 + 2] << 8), t2 + 3 < r3 && (o2 |= e3[t2 + 3]), o2 += e3[t2] << 24 >>> 0), o2;
          }
          function _2(e3, t2, n2, r3) {
            if (r3 || (d2("boolean" == typeof n2, "missing or invalid endian"), d2(null != t2, "missing offset"), d2(t2 + 1 < e3.length, "Trying to read beyond buffer length")), !(e3.length <= t2)) return r3 = o(e3, t2, n2, true), 32768 & r3 ? -1 * (65535 - r3 + 1) : r3;
          }
          function E(e3, t2, n2, r3) {
            if (r3 || (d2("boolean" == typeof n2, "missing or invalid endian"), d2(null != t2, "missing offset"), d2(t2 + 3 < e3.length, "Trying to read beyond buffer length")), !(e3.length <= t2)) return r3 = u2(e3, t2, n2, true), 2147483648 & r3 ? -1 * (4294967295 - r3 + 1) : r3;
          }
          function I2(e3, t2, n2, r3) {
            return r3 || (d2("boolean" == typeof n2, "missing or invalid endian"), d2(t2 + 3 < e3.length, "Trying to read beyond buffer length")), i.read(e3, t2, n2, 23, 4);
          }
          function A2(e3, t2, n2, r3) {
            return r3 || (d2("boolean" == typeof n2, "missing or invalid endian"), d2(t2 + 7 < e3.length, "Trying to read beyond buffer length")), i.read(e3, t2, n2, 52, 8);
          }
          function s2(e3, t2, n2, r3, o2) {
            o2 || (d2(null != t2, "missing value"), d2("boolean" == typeof r3, "missing or invalid endian"), d2(null != n2, "missing offset"), d2(n2 + 1 < e3.length, "trying to write beyond buffer length"), Y2(t2, 65535));
            o2 = e3.length;
            if (!(o2 <= n2)) for (var i2 = 0, u3 = Math.min(o2 - n2, 2); i2 < u3; i2++) e3[n2 + i2] = (t2 & 255 << 8 * (r3 ? i2 : 1 - i2)) >>> 8 * (r3 ? i2 : 1 - i2);
          }
          function l(e3, t2, n2, r3, o2) {
            o2 || (d2(null != t2, "missing value"), d2("boolean" == typeof r3, "missing or invalid endian"), d2(null != n2, "missing offset"), d2(n2 + 3 < e3.length, "trying to write beyond buffer length"), Y2(t2, 4294967295));
            o2 = e3.length;
            if (!(o2 <= n2)) for (var i2 = 0, u3 = Math.min(o2 - n2, 4); i2 < u3; i2++) e3[n2 + i2] = t2 >>> 8 * (r3 ? i2 : 3 - i2) & 255;
          }
          function B2(e3, t2, n2, r3, o2) {
            o2 || (d2(null != t2, "missing value"), d2("boolean" == typeof r3, "missing or invalid endian"), d2(null != n2, "missing offset"), d2(n2 + 1 < e3.length, "Trying to write beyond buffer length"), F2(t2, 32767, -32768)), e3.length <= n2 || s2(e3, 0 <= t2 ? t2 : 65535 + t2 + 1, n2, r3, o2);
          }
          function L2(e3, t2, n2, r3, o2) {
            o2 || (d2(null != t2, "missing value"), d2("boolean" == typeof r3, "missing or invalid endian"), d2(null != n2, "missing offset"), d2(n2 + 3 < e3.length, "Trying to write beyond buffer length"), F2(t2, 2147483647, -2147483648)), e3.length <= n2 || l(e3, 0 <= t2 ? t2 : 4294967295 + t2 + 1, n2, r3, o2);
          }
          function U2(e3, t2, n2, r3, o2) {
            o2 || (d2(null != t2, "missing value"), d2("boolean" == typeof r3, "missing or invalid endian"), d2(null != n2, "missing offset"), d2(n2 + 3 < e3.length, "Trying to write beyond buffer length"), D2(t2, 34028234663852886e22, -34028234663852886e22)), e3.length <= n2 || i.write(e3, t2, n2, r3, 23, 4);
          }
          function x2(e3, t2, n2, r3, o2) {
            o2 || (d2(null != t2, "missing value"), d2("boolean" == typeof r3, "missing or invalid endian"), d2(null != n2, "missing offset"), d2(n2 + 7 < e3.length, "Trying to write beyond buffer length"), D2(t2, 17976931348623157e292, -17976931348623157e292)), e3.length <= n2 || i.write(e3, t2, n2, r3, 52, 8);
          }
          H2.Buffer = f2, H2.SlowBuffer = f2, H2.INSPECT_MAX_BYTES = 50, f2.poolSize = 8192, f2._useTypedArrays = function() {
            ...
            for (var n2 = new f2(t2), r3 = 0, o2 = 0; o2 < e3.length; o2++) {
              var i2 = e3[o2];
              i2.copy(n2, r3), r3 += i2.length;
            }
            return n2;
          }, f2.prototype.write = function(e3, t2, n2, r3) {
            isFinite(t2) ? isFinite(n2) || (r3 = n2, n2 = void 0) : (a3 = r3, r3 = t2, t2 = n2, n2 = a3), t2 = Number(t2) || 0;
            var o2, i2, u3, s3, a3 = this.length - t2;
            switch ((!n2 || a3 < (n2 = Number(n2))) && (n2 = a3), r3 = String(r3 || "utf8").toLowerCase()) {
              case "hex":
                o2 = function(e4, t3, n3, r4) {
                  n3 = Number(n3) || 0;
                  var o3 = e4.length - n3;
                  (!r4 || o3 < (r4 = Number(r4))) && (r4 = o3), d2((o3 = t3.length) % 2 == 0, "Invalid hex string"), o3 / 2 < r4 && (r4 = o3 / 2);
                  for (var i3 = 0; i3 < r4; i3++) {
                    var u4 = parseInt(t3.substr(2 * i3, 2), 16);
                    d2(!isNaN(u4), "Invalid hex string"), e4[n3 + i3] = u4;
                  }
              ...
              case "utf8":
              case "utf-8":
                i2 = this, u3 = t2, s3 = n2, o2 = f2._charsWritten = c(T2(e3), i2, u3, s3);
                break;
              case "ascii":
              case "binary":
                o2 = b2(this, e3, t2, n2);
                break;
              case "base64":
                i2 = this, u3 = t2, s3 = n2, o2 = f2._charsWritten = c(M2(e3), i2, u3, s3);
                break;
              case "ucs2":
              case "ucs-2":
              case "utf16le":
            ...
            var r3, o2, i2, u3, s3 = this;
            if (e3 = String(e3 || "utf8").toLowerCase(), t2 = Number(t2) || 0, (n2 = void 0 !== n2 ? Number(n2) : s3.length) === t2) return "";
            switch (e3) {
              case "hex":
                r3 = function(e4, t3, n3) {
                  ...
                  (!t3 || t3 < 0) && (t3 = 0);
                  (!n3 || n3 < 0 || r4 < n3) && (n3 = r4);
                  for (var o3 = "", i3 = t3; i3 < n3; i3++) o3 += k2(e4[i3]);
                  return o3;
                }(s3, t2, n2);
                break;
              case "utf8":
              case "utf-8":
                r3 = function(e4, t3, n3) {
                  ...
                  for (var i3 = t3; i3 < n3; i3++) e4[i3] <= 127 ? (r4 += N2(o3) + String.fromCharCode(e4[i3]), o3 = "") : o3 += "%" + e4[i3].toString(16);
                  return r4 + N2(o3);
                }(s3, t2, n2);
                break;
              case "ascii":
              case "binary":
                ...
                break;
              case "base64":
                o2 = s3, u3 = n2, r3 = 0 === (i2 = t2) && u3 === o2.length ? a2.fromByteArray(o2) : a2.fromByteArray(o2.slice(i2, u3));
                break;
              case "ucs2":
              case "ucs-2":
              case "utf16le":
              case "utf-16le":
                r3 = function(e4, t3, n3) {
                  for (var r4 = e4.slice(t3, n3), o3 = "", i3 = 0; i3 < r4.length; i3 += 2) o3 += String.fromCharCode(r4[i3] + 256 * r4[i3 + 1]);
                  return o3;
                }(s3, t2, n2);
                break;
              default:
          ...
          }, f2.prototype.copy = function(e3, t2, n2, r3) {
            if (t2 = t2 || 0, (r3 = r3 || 0 === r3 ? r3 : this.length) !== (n2 = n2 || 0) && 0 !== e3.length && 0 !== this.length) {
              d2(n2 <= r3, "sourceEnd < sourceStart"), d2(0 <= t2 && t2 < e3.length, "targetStart out of bounds"), d2(0 <= n2 && n2 < this.length, "sourceStart out of bounds"), d2(0 <= r3 && r3 <= this.length, "sourceEnd out of bounds"), r3 > this.length && (r3 = this.length);
              var o2 = (r3 = e3.length - t2 < r3 - n2 ? e3.length - t2 + n2 : r3) - n2;
              if (o2 < 100 || !f2._useTypedArrays) for (var i2 = 0; i2 < o2; i2++) e3[i2 + t2] = this[i2 + n2];
              else e3._set(this.subarray(n2, n2 + o2), t2);
            }
          }, f2.prototype.slice = function(e3, t2) {
            var n2 = this.length;
            if (e3 = S2(e3, n2, 0), t2 = S2(t2, n2, n2), f2._useTypedArrays) return f2._augment(this.subarray(e3, t2));
            ...
            if (t2 || (d2(null != e3, "missing offset"), d2(e3 < this.length, "Trying to read beyond buffer length")), !(e3 >= this.length)) return this[e3];
            ...
            if (t2 || (d2(null != e3, "missing offset"), d2(e3 < this.length, "Trying to read beyond buffer length")), !(e3 >= this.length)) return 128 & this[e3] ? -1 * (255 - this[e3] + 1) : this[e3];
            ...
            n2 || (d2(null != e3, "missing value"), d2(null != t2, "missing offset"), d2(t2 < this.length, "trying to write beyond buffer length"), Y2(e3, 255)), t2 >= this.length || (this[t2] = e3);
            ...
            n2 || (d2(null != e3, "missing value"), d2(null != t2, "missing offset"), d2(t2 < this.length, "Trying to write beyond buffer length"), F2(e3, 127, -128)), t2 >= this.length || (0 <= e3 ? this.writeUInt8(e3, t2, n2) : this.writeUInt8(255 + e3 + 1, t2, n2));
            ...
            if (t2 = t2 || 0, n2 = n2 || this.length, d2("number" == typeof (e3 = "string" == typeof (e3 = e3 || 0) ? e3.charCodeAt(0) : e3) && !isNaN(e3), "value is not a number"), d2(t2 <= n2, "end < start"), n2 !== t2 && 0 !== this.length) {
              d2(0 <= t2 && t2 < this.length, "start out of bounds"), d2(0 <= n2 && n2 <= this.length, "end out of bounds");
              for (var r3 = t2; r3 < n2; r3++) this[r3] = e3;
            }
          }, f2.prototype.inspect = function() {
            for (var e3 = [], t2 = this.length, n2 = 0; n2 < t2; n2++) if (e3[n2] = k2(this[n2]), n2 === H2.INSPECT_MAX_BYTES) {
              e3[n2 + 1] = "...";
              break;
            }
          ...
          function T2(e3) {
            for (var t2 = [], n2 = 0; n2 < e3.length; n2++) {
              ...
              if (r3 <= 127) t2.push(e3.charCodeAt(n2));
              else for (var o2 = n2, i2 = (55296 <= r3 && r3 <= 57343 && n2++, encodeURIComponent(e3.slice(o2, n2 + 1)).substr(1).split("%")), u3 = 0; u3 < i2.length; u3++) t2.push(parseInt(i2[u3], 16));
            }
            return t2;
          }
          function M2(e3) {
          ...
          function c(e3, t2, n2, r3) {
            for (var o2 = 0; o2 < r3 && !(o2 + n2 >= t2.length || o2 >= e3.length); o2++) t2[o2 + n2] = e3[o2];
            return o2;
          }
          function N2(e3) {
            try {
        ...
        !(function(e2, t, a2, n, r2, o, i, u2, s2) {
          var a2 = c("buffer").Buffer, f2 = 4, l = new a2(f2);
          l.fill(0);
          d2.exports = { hash: function(e3, t2, n2, r3) {
            for (var o2 = t2(function(e4, t3) {
              e4.length % f2 != 0 && (n3 = e4.length + (f2 - e4.length % f2), e4 = a2.concat([e4, l], n3));
              for (var n3, r4 = [], o3 = t3 ? e4.readInt32BE : e4.readInt32LE, i3 = 0; i3 < e4.length; i3 += f2) r4.push(o3.call(e4, i3));
              return r4;
            }(e3 = a2.isBuffer(e3) ? e3 : new a2(e3), r3), 8 * e3.length), t2 = r3, i2 = new a2(n2), u3 = t2 ? i2.writeInt32BE : i2.writeInt32LE, s3 = 0; s3 < o2.length; s3++) u3.call(i2, o2[s3], 4 * s3, true);
            return i2;
          } };
        }).call(this, c("lYpoI2"), "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, c("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/node_modules/gulp-browserify/node_modules/crypto-browserify/helpers.js", "/node_modules/gulp-browserify/node_modules/crypto-browserify");
      }, { buffer: 3, lYpoI2: 11 }], 5: [function(v2, e, _2) {
        !(function(l, c, u2, d2, h, p, g2, y2, w2) {
          var u2 = v2("buffer").Buffer, e2 = v2("./sha"), t = v2("./sha256"), n = v2("./rng"), b2 = { sha1: e2, sha256: t, md5: v2("./md5") }, s2 = 64, a2 = new u2(s2);
          function r2(e3, n2) {
            ...
            return r3 || i("algorithm:", e3, "is not yet supported"), { update: function(e4) {
              ...
              var t2 = u2.concat(o2), t2 = n2 ? function(e5, t3, n3) {
                u2.isBuffer(t3) || (t3 = new u2(t3)), u2.isBuffer(n3) || (n3 = new u2(n3)), t3.length > s2 ? t3 = e5(t3) : t3.length < s2 && (t3 = u2.concat([t3, a2], s2));
                for (var r4 = new u2(s2), o3 = new u2(s2), i2 = 0; i2 < s2; i2++) r4[i2] = 54 ^ t3[i2], o3[i2] = 92 ^ t3[i2];
                return n3 = e5(u2.concat([r4, n3])), e5(u2.concat([o3, n3]));
              }(r3, n2, t2) : r3(t2);
          ...
          a2.fill(0), _2.createHash = function(e3) {
            ...
            if (!t2 || !t2.call) return new u2(n(e3));
            try {
              t2.call(this, void 0, new u2(n(e3)));
            } catch (e4) {
              t2(e4);
            }
          };
        ...
        !(function(e2, r2, o, i, u2, a2, f2, l, y2) {
          ...
          function n(e3, t2) {
            ...
            for (var n2 = 1732584193, r3 = -271733879, o2 = -1732584194, i2 = 271733878, u3 = 0; u3 < e3.length; u3 += 16) {
              var s3 = n2, a3 = r3, f3 = o2, l2 = i2, n2 = c(n2, r3, o2, i2, e3[u3 + 0], 7, -680876936), i2 = c(i2, n2, r3, o2, e3[u3 + 1], 12, -389564586), o2 = c(o2, i2, n2, r3, e3[u3 + 2], 17, 606105819), r3 = c(r3, o2, i2, n2, e3[u3 + 3], 22, -1044525330);
              n2 = c(n2, r3, o2, i2, e3[u3 + 4], 7, -176418897), i2 = c(i2, n2, r3, o2, e3[u3 + 5], 12, 1200080426), o2 = c(o2, i2, n2, r3, e3[u3 + 6], 17, -1473231341), r3 = c(r3, o2, i2, n2, e3[u3 + 7], 22, -45705983), n2 = c(n2, r3, o2, i2, e3[u3 + 8], 7, 1770035416), i2 = c(i2, n2, r3, o2, e3[u3 + 9], 12, -1958414417), o2 = c(o2, i2, n2, r3, e3[u3 + 10], 17, -42063), r3 = c(r3, o2, i2, n2, e3[u3 + 11], 22, -1990404162), n2 = c(n2, r3, o2, i2, e3[u3 + 12], 7, 1804603682), i2 = c(i2, n2, r3, o2, e3[u3 + 13], 12, -40341101), o2 = c(o2, i2, n2, r3, e3[u3 + 14], 17, -1502002290), n2 = d2(n2, r3 = c(r3, o2, i2, n2, e3[u3 + 15], 22, 1236535329), o2, i2, e3[u3 + 1], 5, -165796510), i2 = d2(i2, n2, r3, o2, e3[u3 + 6], 9, -1069501632), o2 = d2(o2, i2, n2, r3, e3[u3 + 11], 14, 643717713), r3 = d2(r3, o2, i2, n2, e3[u3 + 0], 20, -373897302), n2 = d2(n2, r3, o2, i2, e3[u3 + 5], 5, -701558691), i2 = d2(i2, n2, r3, o2, e3[u3 + 10], 9, 38016083), o2 = d2(o2, i2, n2, r3, e3[u3 + 15], 14, -660478335), r3 = d2(r3, o2, i2, n2, e3[u3 + 4], 20, -405537848), n2 = d2(n2, r3, o2, i2, e3[u3 + 9], 5, 568446438), i2 = d2(i2, n2, r3, o2, e3[u3 + 14], 9, -1019803690), o2 = d2(o2, i2, n2, r3, e3[u3 + 3], 14, -187363961), r3 = d2(r3, o2, i2, n2, e3[u3 + 8], 20, 1163531501), n2 = d2(n2, r3, o2, i2, e3[u3 + 13], 5, -1444681467), i2 = d2(i2, n2, r3, o2, e3[u3 + 2], 9, -51403784), o2 = d2(o2, i2, n2, r3, e3[u3 + 7], 14, 1735328473), n2 = h(n2, r3 = d2(r3, o2, i2, n2, e3[u3 + 12], 20, -1926607734), o2, i2, e3[u3 + 5], 4, -378558), i2 = h(i2, n2, r3, o2, e3[u3 + 8], 11, -2022574463), o2 = h(o2, i2, n2, r3, e3[u3 + 11], 16, 1839030562), r3 = h(r3, o2, i2, n2, e3[u3 + 14], 23, -35309556), n2 = h(n2, r3, o2, i2, e3[u3 + 1], 4, -1530992060), i2 = h(i2, n2, r3, o2, e3[u3 + 4], 11, 1272893353), o2 = h(o2, i2, n2, r3, e3[u3 + 7], 16, -155497632), r3 = h(r3, o2, i2, n2, e3[u3 + 10], 23, -1094730640), n2 = h(n2, r3, o2, i2, e3[u3 + 13], 4, 681279174), i2 = h(i2, n2, r3, o2, e3[u3 + 0], 11, -358537222), o2 = h(o2, i2, n2, r3, e3[u3 + 3], 16, -722521979), r3 = h(r3, o2, i2, n2, e3[u3 + 6], 23, 76029189), n2 = h(n2, r3, o2, i2, e3[u3 + 9], 4, -640364487), i2 = h(i2, n2, r3, o2, e3[u3 + 12], 11, -421815835), o2 = h(o2, i2, n2, r3, e3[u3 + 15], 16, 530742520), n2 = p(n2, r3 = h(r3, o2, i2, n2, e3[u3 + 2], 23, -995338651), o2, i2, e3[u3 + 0], 6, -198630844), i2 = p(i2, n2, r3, o2, e3[u3 + 7], 10, 1126891415), o2 = p(o2, i2, n2, r3, e3[u3 + 14], 15, -1416354905), r3 = p(r3, o2, i2, n2, e3[u3 + 5], 21, -57434055), n2 = p(n2, r3, o2, i2, e3[u3 + 12], 6, 1700485571), i2 = p(i2, n2, r3, o2, e3[u3 + 3], 10, -1894986606), o2 = p(o2, i2, n2, r3, e3[u3 + 10], 15, -1051523), r3 = p(r3, o2, i2, n2, e3[u3 + 1], 21, -2054922799), n2 = p(n2, r3, o2, i2, e3[u3 + 8], 6, 1873313359), i2 = p(i2, n2, r3, o2, e3[u3 + 15], 10, -30611744), o2 = p(o2, i2, n2, r3, e3[u3 + 6], 15, -1560198380), r3 = p(r3, o2, i2, n2, e3[u3 + 13], 21, 1309151649), n2 = p(n2, r3, o2, i2, e3[u3 + 4], 6, -145523070), i2 = p(i2, n2, r3, o2, e3[u3 + 11], 10, -1120210379), o2 = p(o2, i2, n2, r3, e3[u3 + 2], 15, 718787259), r3 = p(r3, o2, i2, n2, e3[u3 + 9], 21, -343485551), n2 = g2(n2, s3), r3 = g2(r3, a3), o2 = g2(o2, f3), i2 = g2(i2, l2);
            }
            return Array(n2, r3, o2, i2);
          }
          function s2(e3, t2, n2, r3, o2, i2) {
            return g2((t2 = g2(g2(t2, e3), g2(r3, i2))) << o2 | t2 >>> 32 - o2, n2);
          }
          function c(e3, t2, n2, r3, o2, i2, u3) {
            return s2(t2 & n2 | ~t2 & r3, e3, t2, o2, i2, u3);
          }
          function d2(e3, t2, n2, r3, o2, i2, u3) {
            return s2(t2 & r3 | n2 & ~r3, e3, t2, o2, i2, u3);
          }
          function h(e3, t2, n2, r3, o2, i2, u3) {
            return s2(t2 ^ n2 ^ r3, e3, t2, o2, i2, u3);
          }
          function p(e3, t2, n2, r3, o2, i2, u3) {
            return s2(n2 ^ (t2 | ~r3), e3, t2, o2, i2, u3);
          }
          function g2(e3, t2) {
        ...
        !(function(e2, t2, n, r2, o, i, u2, s2, f2) {
          var a2;
          l.exports = a2 || function(e3) {
            for (var t3, n2 = new Array(e3), r3 = 0; r3 < e3; r3++) 0 == (3 & r3) && (t3 = 4294967296 * Math.random()), n2[r3] = t3 >>> ((3 & r3) << 3) & 255;
            return n2;
          };
        }).call(this, e("lYpoI2"), "undefined" != typeof self ? self : "undefined" != typeof window ? window : {}, e("buffer").Buffer, arguments[3], arguments[4], arguments[5], arguments[6], "/node_modules/gulp-browserify/node_modules/crypto-browserify/rng.js", "/node_modules/gulp-browserify/node_modules/crypto-browserify");
      }, { buffer: 3, lYpoI2: 11 }], 8: [function(c, d2, e) {
        !(function(e2, t, n, r2, o, s2, a2, f2, l) {
          var i = c("./helpers");
          function u2(l2, c2) {
            l2[c2 >> 5] |= 128 << 24 - c2 % 32, l2[15 + (c2 + 64 >> 9 << 4)] = c2;
            for (var e3, t2, n2, r3 = Array(80), o2 = 1732584193, i2 = -271733879, u3 = -1732584194, s3 = 271733878, d3 = -1009589776, h = 0; h < l2.length; h += 16) {
              for (var p = o2, g2 = i2, y2 = u3, w2 = s3, b2 = d3, a3 = 0; a3 < 80; a3++) {
                r3[a3] = a3 < 16 ? l2[h + a3] : v2(r3[a3 - 3] ^ r3[a3 - 8] ^ r3[a3 - 14] ^ r3[a3 - 16], 1);
                var f3 = m2(m2(v2(o2, 5), (f3 = i2, t2 = u3, n2 = s3, (e3 = a3) < 20 ? f3 & t2 | ~f3 & n2 : !(e3 < 40) && e3 < 60 ? f3 & t2 | f3 & n2 | t2 & n2 : f3 ^ t2 ^ n2)), m2(m2(d3, r3[a3]), (e3 = a3) < 20 ? 1518500249 : e3 < 40 ? 1859775393 : e3 < 60 ? -1894007588 : -899497514)), d3 = s3, s3 = u3, u3 = v2(i2, 30), i2 = o2, o2 = f3;
              }
              o2 = m2(o2, p), i2 = m2(i2, g2), u3 = m2(u3, y2), s3 = m2(s3, w2), d3 = m2(d3, b2);
            }
            return Array(o2, i2, u3, s3, d3);
          }
          function m2(e3, t2) {
            var n2 = (65535 & e3) + (65535 & t2);
            return (e3 >> 16) + (t2 >> 16) + (n2 >> 16) << 16 | 65535 & n2;
        ...
        !(function(e2, t, n, r2, u2, s2, a2, f2, l) {
          function b2(e3, t2) {
            var n2 = (65535 & e3) + (65535 & t2);
            return (e3 >> 16) + (t2 >> 16) + (n2 >> 16) << 16 | 65535 & n2;
          }
          function o(e3, l2) {
            ...
            for (var r3, o2, h = 0; h < e3.length; h += 16) {
              for (var i2 = t2[0], u3 = t2[1], s3 = t2[2], p = t2[3], a3 = t2[4], g2 = t2[5], y2 = t2[6], w2 = t2[7], f3 = 0; f3 < 64; f3++) n2[f3] = f3 < 16 ? e3[f3 + h] : b2(b2(b2((o2 = n2[f3 - 2], m2(o2, 17) ^ m2(o2, 19) ^ v2(o2, 10)), n2[f3 - 7]), (o2 = n2[f3 - 15], m2(o2, 7) ^ m2(o2, 18) ^ v2(o2, 3))), n2[f3 - 16]), c2 = b2(b2(b2(b2(w2, m2(o2 = a3, 6) ^ m2(o2, 11) ^ m2(o2, 25)), a3 & g2 ^ ~a3 & y2), d3[f3]), n2[f3]), r3 = b2(m2(r3 = i2, 2) ^ m2(r3, 13) ^ m2(r3, 22), i2 & u3 ^ i2 & s3 ^ u3 & s3), w2 = y2, y2 = g2, g2 = a3, a3 = b2(p, c2), p = s3, s3 = u3, u3 = i2, i2 = b2(c2, r3);
              t2[0] = b2(i2, t2[0]), t2[1] = b2(u3, t2[1]), t2[2] = b2(s3, t2[2]), t2[3] = b2(p, t2[3]), t2[4] = b2(a3, t2[4]), t2[5] = b2(g2, t2[5]), t2[6] = b2(y2, t2[6]), t2[7] = b2(w2, t2[7]);
            }
            return t2;
          }
        ...
        !(function(e2, t2, n, r2, o, i, u2, s2, a2) {
          f2.read = function(e3, t3, n2, r3, o2) {
            var i2, u3, l = 8 * o2 - r3 - 1, c = (1 << l) - 1, d2 = c >> 1, s3 = -7, a3 = n2 ? o2 - 1 : 0, f3 = n2 ? -1 : 1, o2 = e3[t3 + a3];
            for (a3 += f3, i2 = o2 & (1 << -s3) - 1, o2 >>= -s3, s3 += l; 0 < s3; i2 = 256 * i2 + e3[t3 + a3], a3 += f3, s3 -= 8) ;
            for (u3 = i2 & (1 << -s3) - 1, i2 >>= -s3, s3 += r3; 0 < s3; u3 = 256 * u3 + e3[t3 + a3], a3 += f3, s3 -= 8) ;
            if (0 === i2) i2 = 1 - d2;
            else {
              if (i2 === c) return u3 ? NaN : 1 / 0 * (o2 ? -1 : 1);
              u3 += Math.pow(2, r3), i2 -= d2;
            }
            return (o2 ? -1 : 1) * u3 * Math.pow(2, i2 - r3);
          }, f2.write = function(e3, t3, l, n2, r3, c) {
            var o2, i2, u3 = 8 * c - r3 - 1, s3 = (1 << u3) - 1, a3 = s3 >> 1, d2 = 23 === r3 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, f3 = n2 ? 0 : c - 1, h = n2 ? 1 : -1, c = t3 < 0 || 0 === t3 && 1 / t3 < 0 ? 1 : 0;
            for (t3 = Math.abs(t3), isNaN(t3) || t3 === 1 / 0 ? (i2 = isNaN(t3) ? 1 : 0, o2 = s3) : (o2 = Math.floor(Math.log(t3) / Math.LN2), t3 * (n2 = Math.pow(2, -o2)) < 1 && (o2--, n2 *= 2), 2 <= (t3 += 1 <= o2 + a3 ? d2 / n2 : d2 * Math.pow(2, 1 - a3)) * n2 && (o2++, n2 /= 2), s3 <= o2 + a3 ? (i2 = 0, o2 = s3) : 1 <= o2 + a3 ? (i2 = (t3 * n2 - 1) * Math.pow(2, r3), o2 += a3) : (i2 = t3 * Math.pow(2, a3 - 1) * Math.pow(2, r3), o2 = 0)); 8 <= r3; e3[l + f3] = 255 & i2, f3 += h, i2 /= 256, r3 -= 8) ;
        ...
        !(function(e2, t2, n, r2, o, f2, l, c, d2) {
          var i, u2, s2;
          function a2() {
          }
          (e2 = h.exports = {}).nextTick = (u2 = "undefined" != typeof window && window.setImmediate, s2 = "undefined" != typeof window && window.postMessage && window.addEventListener, u2 ? function(e3) {
...
function md5ff(a2, b2, c, d2, x2, s2, t) {
  return md5cmn(b2 & c | ~b2 & d2, a2, b2, x2, s2, t);
}
function md5gg(a2, b2, c, d2, x2, s2, t) {
  return md5cmn(b2 & d2 | c & ~d2, a2, b2, x2, s2, t);
}
function md5hh(a2, b2, c, d2, x2, s2, t) {
  return md5cmn(b2 ^ c ^ d2, a2, b2, x2, s2, t);
}
function md5ii(a2, b2, c, d2, x2, s2, t) {
  return md5cmn(c ^ (b2 | ~d2), a2, b2, x2, s2, t);
}
var md5_default = md5;
...
function sha1(bytes) {
  ...
  for (let i = 0; i < N2; ++i) {
    ...
    for (let t = 0; t < 80; ++t) {
      ...
      const T2 = ROTL(a2, 5) + f(s2, b2, c, d2) + e + K2[s2] + W2[t] >>> 0;
      e = d2;
      d2 = c;
      c = ROTL(b2, 30) >>> 0;
      b2 = a2;
...
var H = (i, e, t) => e in i ? se(i, e, { enumerable: true, configurable: true, writable: true, value: t }) : i[e] = t;
var T = (i, e) => {
  for (var t in e || (e = {})) ae.call(e, t) && H(i, t, e[t]);
  if (_) for (var t of _(e)) ce.call(e, t) && H(i, t, e[t]);
  return i;
};
var F = (i, e) => ne(i, oe(e));
var J = (i, e, t) => e.has(i) || z("Cannot " + t);
var s = (i, e, t) => (J(i, e, "read from private field"), t ? t.call(i) : e.get(i));
var u = (i, e, t) => e.has(i) ? z("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(i) : e.set(i, t);
var d = (i, e, t, r2) => (J(i, e, "write to private field"), r2 ? r2.call(i, t) : e.set(i, t), t);
var a = (i, e, t) => new Promise((r2, o) => {
  var n = (p) => {
    try {
      f2(t.next(p));
    } catch (h) {
  ...
  }, f2 = (p) => p.done ? r2(p.value) : Promise.resolve(p.value).then(n, l);
...
function X(i) {
  var e;
  return typeof process != "undefined" && (e = process == null ? void 0 : process.env[i]) != null ? e : null;
}
var he = "6QrJZ7pFCmBZAeIJF7IArvkCz+EtzA0RVcpHkiQIsQyhs7QtCS9P+CueZdHfB2OtJcgX3BbqY9pfpWeAVTqCwQ==";
function Z(i) {
  return encodeURIComponent(i).replace(/[!'()*]/g, (e) => `%${e.charCodeAt(0).toString(16).toUpperCase()}`);
}
function ge(i) {
  let e = Math.floor(Date.now() / 1e3).toString(), t = Math.random().toString(36).substring(2, 15), r2 = T({}, i.query), o = Object.keys(r2).sort().map((c) => `${Z(c)}=${Z(String(r2[c]))}`).join("&"), n = { "x-timestamp": e, "x-nonce": t }, l = Object.keys(n).sort().map((c) => `${c}:${n[c]}`).join(`
`), f2 = i.body && !(i.body instanceof FormData) ? JSON.stringify(i.body) : "", p = (0, import_sha256.default)(f2).toString(import_enc_hex.default), h = [o, l, p].join(`
`), R = import_enc_base64.default.stringify((0, import_hmac_sha256.default)(h, he)), E = new Headers(i.headers);
  Object.entries(n).forEach(([c, j]) => {
    E.set(c, j);
  }), E.set("X-Sign", R), i.headers = E;
}
var W = /* @__PURE__ */ new Map();
function fe(i, e) {
  var l;
  let t = T({}, e);
  e.body instanceof FormData && (t.body = Array.from(e.body.entries())), t.headers = void 0;
  let r2 = (0, import_object_hash.default)([i, t]), o = Date.now(), n = ((l = W.get(r2)) == null ? void 0 : l.filter((f2) => o - f2 < 1e3)) || [];
  if (n.length >= 4) throw new g(429, "Too many requests");
  n.push(o), W.set(r2, n);
}
function te(i, e, t, r2 = false) {
  t.headers = new Headers(t.headers), i.auth.accessToken && t.headers.set("Authorization", `Bearer ${i.auth.accessToken}`), r2 && (t.headers.get("Accept") || t.headers.set("Accept", "text/event-stream"), t.headers.get("Cache-Control") || t.headers.set("Cache-Control", "no-cache"), t.headers.get("X-Accel-Buffering") || t.headers.set("X-Accel-Buffering", "no")), fe(e, t), ge(t);
}
function m(i, e, t = {}) {
  te(i, e, t);
  let r2 = i.auth.isAuthenticated;
  return ofetch(e, F(T({ baseURL: i.config.apiBaseUrl }, t), { onResponse: ({ response: o }) => {
    var n;
    !y && r2 && ((n = o._data) == null ? void 0 : n.code) === 2100 && i.auth.signOut();
  } }));
}
function ie(r2, o) {
  return a(this, arguments, function* (i, e, t = {}) {
    return te(i, e, t, true), yield ofetch(e, F(T({ baseURL: i.config.apiBaseUrl }, t), { responseType: "stream" }));
  });
}
...
var v = class {
  constructor(e) {
    u(this, S);
    u(this, P, `lumi-auth-${v4_default()}`);
    u(this, x, null);
    d(this, S, e), Promise.resolve().then(() => {
      !y && this.isAuthenticated && this.refreshUser();
    });
  }
  get accessToken() {
    if (y) {
      let e = s(this, S).config.authorization;
      return e ? e.replace("Bearer ", "") : null;
    }
    return G("lumi-access-token");
  }
  set accessToken(e) {
    if (y) {
      s(this, S).config.authorization = e ? `Bearer ${e}` : void 0;
      return;
    }
    K("lumi-access-token", e);
  }
  get user() {
    return y ? s(this, x) : G("lumi-user");
  }
  set user(e) {
    if (y) {
      d(this, x, e);
  ...
  signIn() {
    if (y) throw new Error("auth.signIn() can only be called on the client side");
    let e = 800, t = 600, r2 = (window.screen.width - e) / 2, o = (window.screen.height - t) / 2, n = window.open(s(this, S).config.authOrigin, s(this, P), `width=${e},height=${t},left=${r2},top=${o}`), l;
    return new Promise((f2, p) => {
      if (!n) return p(new Error("Open auth window failed"));
      let h = setInterval(() => {
        n.closed && p(new Error("Auth window closed"));
      }, 1e3), R = (c) => {
        n.closed || (n.focus(), c.stopPropagation(), c.preventDefault());
      }, E = ({ data: c, origin: j, source: re }) => {
        if (!(j !== s(this, S).config.authOrigin || re !== n)) switch (c == null ? void 0 : c.type) {
          case "lumi-ready": {
            n.postMessage({ type: "lumi-init", data: { projectId: s(this, S).config.projectId, icon: Q(), title: Y() } }, s(this, S).config.authOrigin);
            break;
          }
          case "lumi-sign-in": {
            if (c.data.projectId !== s(this, S).config.projectId) break;
            n.close(), window.focus(), this.accessToken = c.data.accessToken, this.user = c.data.user, f2(c.data);
            break;
          }
        }
      };
      window.addEventListener("message", E), document.addEventListener("click", R, true), l = () => {
        clearInterval(h), window.removeEventListener("message", E), document.removeEventListener("click", R, true);
      };
    }).finally(() => l == null ? void 0 : l());
  }
  signOut() {
    if (y) throw new Error("auth.signOut() can only be called on the client side");
    this.accessToken = null, this.user = null;
  }
  refreshUser() {
    return a(this, null, function* () {
      let e = yield m(s(this, S), "/lm/user/info", { method: "POST" });
      if (e.code !== 200) throw new Error(e.message);
      return this.user = e.data, e.data;
    });
  }
  onAuthChange(e) {
    if (y) throw new Error("auth.onAuthChange() can only be called on the client side");
    let t = (r2) => {
...
S = /* @__PURE__ */ new WeakMap(), P = /* @__PURE__ */ new WeakMap(), x = /* @__PURE__ */ new WeakMap();
var w;
var O = class {
  constructor(e, t) {
    u(this, w);
    d(this, w, e), this.entityName = t;
  }
  list() {
    return a(this, arguments, function* ({ filter: e, sort: t, limit: r2, skip: o } = {}) {
      if (r2) {
        let n = yield m(s(this, w), this.uri("/find"), { method: "POST", body: { filter: e, sort: t, limit: r2, skip: o } });
        if (n.code !== 200) throw new Error(n.message);
        return n.data;
      } else {
        let n = yield m(s(this, w), this.uri("/list"), { method: "POST", body: { filter: e, sort: t } });
        if (n.code !== 200) throw new Error(n.message);
  ...
  get(e) {
    return a(this, null, function* () {
      let t = yield m(s(this, w), this.uri(`/${e}`), { method: "GET" });
  ...
  create(e) {
    return a(this, null, function* () {
      let t = yield m(s(this, w), this.uri(), { method: "POST", body: e });
      if (t.code !== 200) throw new Error(t.message);
      return t.data;
    });
  }
  createMany(e) {
    return a(this, null, function* () {
      let t = yield m(s(this, w), this.uri("/batch"), { method: "POST", body: e });
      if (t.code !== 200) throw new Error(t.message);
      return t.data;
    });
  }
  update(e, t) {
    return a(this, null, function* () {
      let r2 = yield m(s(this, w), this.uri(), { method: "PUT", body: { filter: { _id: e }, update: t } });
  ...
  delete(e) {
    return a(this, null, function* () {
      let t = yield m(s(this, w), this.uri(`/${e}`), { method: "DELETE" });
      if (t.code !== 200) throw new Error(t.message);
    });
  }
  deleteMany(e) {
    return a(this, null, function* () {
      let t = yield m(s(this, w), this.uri("/batch-by-ids"), { method: "DELETE", params: { ids: e } });
      if (t.code !== 200) throw new Error(t.message);
    });
  }
  uri(e = "") {
    return `/lm/${s(this, w).config.projectId}/${this.entityName}/documents${e}`;
  }
};
...
var M = class {
  constructor(e) {
    u(this, L);
    return d(this, L, e), new Proxy(this, { get(t, r2) {
      return r2 in t || (t[r2] = new O(s(t, L), r2)), t[r2];
    } });
  }
};
...
var U = class {
  ...
  invoke(e, t = {}) {
    return s(this, A).auth.accessToken && (t.headers = T({ Authorization: `Bearer ${s(this, A).auth.accessToken}` }, t.headers)), ofetch(`/v1/functions/${s(this, A).config.projectId}/${e}`, T({ baseURL: s(this, A).config.apiBaseUrl }, t));
  }
};
...
var k = class {
  ...
  generateText(r2) {
    return a(this, arguments, function* ({ model: e = "gemini-2.5-flash", messages: t }) {
      let o = this.checkLumiApiKey(), n = yield m(s(this, b), `/lm/${s(this, b).config.projectId}/ai/chat/completions`, { method: "POST", body: { lumiApiKey: o, modelName: e, chatMessages: t } });
      if (n.code !== 200) throw new g(n.code, n.message);
      return n.data;
    });
  }
  generateTextStream(r2) {
    return a(this, arguments, function* ({ model: e = "gemini-2.5-flash", messages: t }) {
      let o = this.checkLumiApiKey();
      return ie(s(this, b), `/lm/${s(this, b).config.projectId}/ai/chat/stream`, { method: "POST", body: { lumiApiKey: o, modelName: e, chatMessages: t } });
    });
  }
  generateImage(r2) {
    return a(this, arguments, function* ({ model: e = "gemini-2.5-flash-image", messages: t }) {
      let o = this.checkLumiApiKey(), { code: n, message: l, data: f2 } = yield m(s(this, b), `/lm/${s(this, b).config.projectId}/ai/image/task`, { method: "POST", body: { lumiApiKey: o, modelName: e, chatMessages: t } });
      if (n !== 200) throw new g(n, l);
      let p = f2, h = 1e3;
      for (; p.generationStatus === "PROCESSING"; ) {
        yield V(h), h < 5e3 && (h += 500);
        let { code: R, message: E, data: c } = yield m(s(this, b), `/lm/${s(this, b).config.projectId}/ai/image/get`, { method: "POST", body: { lumiApiKey: o, messageId: p.messageId } });
        if (R !== 200) throw new g(R, E);
        p = c;
      }
      return p;
    });
  ...
  parseStream(e) {
    return a(this, null, function* () {
      return e.pipeThrough(new TextDecoderStream()).pipeThrough(new EventSourceParserStream()).pipeThrough(new TransformStream({ transform: (t, r2) => {
        try {
          let o = JSON.parse(t.data);
          r2.enqueue({ event: t.event, data: o });
        } catch (o) {
...
${t.data}`);
  ...
  checkLumiApiKey() {
    if (!y) throw new g(400, "lumi.tools.ai is only available on the server-side");
    let e = X("LUMI_API_KEY");
    if (!e) throw new g(400, "LUMI_API_KEY is required");
    return e;
  }
};
...
var D = class {
  ...
  send(p) {
    return a(this, arguments, function* ({ to: e, subject: t, fromName: r2, html: o, text: n = "", replyTo: l, scheduledAt: f2 }) {
      if (!e || !t || !o && !n) throw new Error("Failed to send email: Missing required parameters.");
      typeof e == "string" && (e = [e]), typeof l == "string" && (l = [l]);
      let h = yield m(s(this, I), `/lm/${s(this, I).config.projectId}/email/send`, { method: "POST", body: { to: e, subject: t, fromName: r2, html: o, text: n, replyTo: l, scheduledAt: f2 } });
      if (h.code !== 200) throw new g(h.code, h.message);
    });
  }
};
...
var $ = class {
  ...
  upload(e) {
    return a(this, null, function* () {
      ...
      let r2 = yield m(s(this, C), `/lm/${s(this, C).config.projectId}/file/batch`, { method: "POST", body: t });
      if (r2.code !== 200) throw new g(r2.code, r2.message);
      return r2.data;
    });
  }
  delete(e) {
    return a(this, null, function* () {
      let t = yield m(s(this, C), `/lm/${s(this, C).config.projectId}/file/batch`, { method: "DELETE", body: { fileUrls: e } });
      if (t.code !== 200) throw new g(t.code, t.message);
    });
  }
};
...
var q = class {
  constructor(e) {
    u(this, N);
    d(this, N, e), this.email = new D(e), this.file = new $(e), this.ai = new k(e);
  }
};
N = /* @__PURE__ */ new WeakMap();
var B = class {
  constructor(e) {
    this.config = e, this.auth = new v(this), this.entities = new M(this), this.tools = new q(this), this.functions = new U(this);
  }
};
function yt(i) {
  return new B(i);
